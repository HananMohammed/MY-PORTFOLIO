...
<head>
    ...
    <title>WE-CODERS|<?php echo $__env->yieldContent('title'); ?></title>
    <!-- Favicons -->
    <link href="<?php echo e(asset_public('front/assets/images/logo.png')); ?>" rel="icon">
    <link href="<?php echo e(asset_public('front/assets/images/logo.png')); ?>" rel="apple-touch-icon">
