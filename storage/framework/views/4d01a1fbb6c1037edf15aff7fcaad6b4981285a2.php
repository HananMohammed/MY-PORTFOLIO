...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo'); ?> 
             <img src="<?php echo e(asset_public('front/assets/images/hanan.png')); ?>" class="logo-img"/>
         <?php $__env->endSlot(); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/MY-PORTFOLIO/resources/views/auth/login.blade.php ENDPATH**/ ?>