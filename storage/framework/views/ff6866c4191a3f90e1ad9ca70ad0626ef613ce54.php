                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo app('translator')->get('admin.create-project'); ?></h3>
                            </div>
                            <!--begin::Form-->
                            <form action="<?php echo e(route('admin.projects.store')); ?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <?php echo csrf_field(); ?>
                                    <?php echo $__env->make('admin.project.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MY-PORTFOLIO\resources\views/admin/project/create.blade.php ENDPATH**/ ?>