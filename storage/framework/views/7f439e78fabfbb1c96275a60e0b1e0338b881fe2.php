    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12">
            <div class="form-group">
                ...
                <input type="text"  name="title[]"  value="<?php echo e(old('title.0')??$slider->getTranslation('title','en')); ?>" class="form-control " id="title_en"  placeholder="<?php echo app('translator')->get('admin.enter-en-title'); ?>" >
            </div>
        </div>
        <div class="col-lg-6 col-sm-12">
            <div class="form-group">
                <label for="title_ar"><?php echo app('translator')->get('admin.title-ar'); ?><label class="text-danger">*</label></label>
                <input type="text"  name="title[]"  value="<?php echo e(old('title.1')??$slider->getTranslation('title','ar')); ?>" class="form-control " id="title_ar"  placeholder="<?php echo app('translator')->get('admin.enter-ar-title'); ?>" >
            </div>
        </div>
        <div class="col-lg-6 col-sm-12">
            <div class="form-group">
                ...
                <textarea type="text" name="text[]" class="form-control summernote" id="text_en" placeholder="<?php echo app('translator')->get('dashboard.enter-english-text'); ?>" >
                    <?php echo e(old('text.0')??$slider->getTranslation('text','en')); ?>
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="form-group">
                ...
                <textarea type="text" name="text[]" class="form-control summernote" id="text_ar" placeholder="<?php echo app('translator')->get('dashboard.enter-arabic-text'); ?>" >
                    <?php echo e(old('text.1')??$slider->getTranslation('text','ar')); ?>
        ...
        <div class="col-lg-12 col-xl-12">
            <div class="image-input image-input-outline" id="kt_contacts_edit_avatar1" style="background-image:url(<?php echo e(asset_public('admin/media/gym_images/il_570xN.1580358345_5585.jpg')); ?>) ;width:300px;height: 220px;">
                <div class="image-input-wrapper"  style="background-image:<?php if(!empty($slider->toArray())): ?> url(<?php echo e(asset_public('storage/uploads/'.$slider->image)); ?>) <?php else: ?> url(<?php echo e(asset_public('admin/assets/media/photography.svg')); ?>) <?php endif; ?>; width:300px;height: 220px;"></div>
...
<?php /**PATH C:\xampp\htdocs\we-coders\resources\views/admin/homepage/slider/form.blade.php ENDPATH**/ ?>