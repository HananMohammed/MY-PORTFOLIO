<?php $__env->startSection('title', 'Project Category'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5"><?php echo app('translator')->get('admin.project-category'); ?></h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.project-categories.index')); ?>" class="text-muted"><?php echo app('translator')->get('admin.project-category'); ?></a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Subheader-->
    <?php echo $__env->make('admin.project.category.form_store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.project.category.form_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--begin::Entry-->
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label"><?php echo app('translator')->get('admin.address'); ?></h3>
                    </div>
                                    ...
                                    <?php if(count($projectCategories)>0): ?>
                                        ...
                                        <?php $__currentLoopData = $projectCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($category->user()->pluck('name')[0]); ?></td>
                                                <td nowrap="nowrap"><?php echo e($category->id); ?></td>
                                            </tr>
        ...
        $("#newsModalEdit").on('show.bs.modal',function(event){
            ...
            $.ajax({
                ...
                success :function(data){
                    let url = "<?php echo e(url(app()->getLocale().'/admin/project-categories/'.':id')); ?>";
                    url = url.replace(':id', id);
                    $('#editForm').attr('action',url);
                    $('#categoryEdit_en').attr('value',data.title.en);
                    $('#categoryEdit_ar').attr('value',data.title.ar);
...
<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
    ...
    <label class="checkbox checkbox-single">
        ...
        <label class="checkbox checkbox-single">
            ...
            <a href="${currentLocation}/project-categories/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MY-PORTFOLIO\resources\views/admin/project/category/index.blade.php ENDPATH**/ ?>