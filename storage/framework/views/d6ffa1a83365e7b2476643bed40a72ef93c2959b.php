...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5"><?php echo app('translator')->get('admin.address'); ?></h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.addresses.index')); ?>" class="text-muted"><?php echo app('translator')->get('admin.address'); ?></a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Subheader-->
    <?php echo $__env->make('admin.settings.address.form_store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.settings.address.form_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--begin::Entry-->
                                    ...
                                    <?php if(count($addresses)>0): ?>
                                        ...
                                        <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($address->user()->pluck('name')[0]); ?></td>
                                                <td nowrap="nowrap"><?php echo e($address->id); ?></td>
                                            </tr>
        ...
        $("#newsModalEdit").on('show.bs.modal',function(event){
            ...
            $.ajax({
                ...
                success :function(data){
                    let url = "<?php echo e(url(app()->getLocale().'/admin/addresses/'.':id')); ?>";
                    url = url.replace(':id', id);
                    $('#editForm').attr('action',url);
                    $('#addressEdit_en').attr('value',data.address.en);
                    $('#addressEdit_ar').attr('value',data.address.ar);
...
<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
    ...
    <label class="checkbox checkbox-single">
        ...
        <label class="checkbox checkbox-single">
            ...
            <a href="${currentLocation}/addresses/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MY-PORTFOLIO\resources\views/admin/settings/address/index.blade.php ENDPATH**/ ?>