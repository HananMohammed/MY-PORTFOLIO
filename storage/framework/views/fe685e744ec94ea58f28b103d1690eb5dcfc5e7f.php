        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5"><?php echo app('translator')->get('admin.services'); ?></h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.services.index')); ?>" class="text-muted"><?php echo app('translator')->get('admin.services'); ?></a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label"><?php echo app('translator')->get('admin.services'); ?></h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="<?php echo e(route('admin.services.create')); ?>" class="btn btn-primary font-weight-bolder d-flex">
                                    ...
                                    <?php if(count($services)>0): ?>
                                        ...
                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo e(asset_public('storage/uploads/'.$service->image)); ?>" style="width: 100px;height: 60px;"></td>
                                                <td><?php echo e($service->title); ?></td>
                                                <td><?php echo $service->text; ?></td>
                                                <td><?php echo e($service->user()->pluck('name')[0]); ?></td>
                                                <td nowrap="nowrap"><?php echo e($service->id); ?></td>
                                            </tr>
...
<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
    ...
    <label class="checkbox checkbox-single">
        ...
        <label class="checkbox checkbox-single">
            ...
            <a href="${currentLocation}/services/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MY-PORTFOLIO\resources\views/admin/services/index.blade.php ENDPATH**/ ?>