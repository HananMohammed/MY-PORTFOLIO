                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="form-group">
                            <label for="emailEdit"><?php echo app('translator')->get('admin.email'); ?><label class="text-danger">*</label></label>
                            <input id="emailEdit" name="email" type="email"  class="form-control"  value="<?php echo e(old('email')); ?>" placeholder="Enter Email Address">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-12" id="receiveContacts">
                            ...
                            <label>
                             <input type="checkbox" name="receive_contacts" id="receivedContactsStatusEdit"/>
                             <span></span>
                            </label>
                           </span>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\MY-PORTFOLIO\resources\views/admin/settings/email/form_edit.blade.php ENDPATH**/ ?>