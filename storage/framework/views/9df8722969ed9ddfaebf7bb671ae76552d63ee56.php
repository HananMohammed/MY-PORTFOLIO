        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="#"><?php echo app('translator')->get('front.home'); ?></a></li>
                        ...
                        <li><i class="bx bx-chevron-right"></i> <a href="#team"><?php echo app('translator')->get('front.team'); ?></a></li>
