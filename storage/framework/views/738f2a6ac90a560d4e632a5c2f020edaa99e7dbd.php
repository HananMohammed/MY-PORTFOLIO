                ...
                <div class="d-flex flex-row">
                            ...
                            <div class="card-body px-5">
                                ...
                                <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                    ...
                                    <div class="navi-item my-2">
                                        <a href="javascript:void(0)" class="navi-link active" id="inbox">
                    ...
                    <div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_list">
                        ...
                        <div class="card card-custom card-stretch">
                            ...
                            <!--end::Header-->
                            <!--begin::Body-->
                                <div class="card-body table-responsive px-0" id="inboxCard">
                                </div>
                                <!--end::Items-->
                            </div>
                            <!--end::Body-->
...
<script type="text/javascript">
    $(document).on("click","#inbox", function () {
        ...
        let url = window.location.href +  "/ajax-inbox";
        console.log(url)
        $.ajax({
            url:url,
            type:"GET",
            ...
            success:function(response){
                if(response) {
                    ...
                    <a href="javascript:void(0)" data-id="${value.id}" class="btn btn-icon btn-xs btn-hover-text-warning active" data-toggle="tooltip" data-placement="right" title="" data-original-title="Star">
