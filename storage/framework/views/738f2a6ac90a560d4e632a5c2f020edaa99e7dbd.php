<?php $__env->startSection('title', 'Contacts Reply'); ?>
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <a href="javascript:void(0)" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?php echo app('translator')->get('admin.inbox-details'); ?></a>
                            </div>
                        </div>
                        <!--end::User-->
                        <!--begin::Nav-->
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded" id="style-10" style=" overflow: auto; height: 400px">
                            ...
                            <div class="navi-item mb-2"  >
                                <a href="javascript:void(0)" class="navi-link py-4 emailDetails" data-id="<?php echo e($contact->id); ?>" data-email="<?php echo e($contact->email); ?>" data-subject="<?php echo e($contact->subject); ?>"  role="button" data-toggle="popover" data-trigger="click" title="<?php echo e($contact->subject); ?>" data-content="<?php echo e($contact->message); ?>" tabindex="<?php echo e($loop->index); ?>" >
                                    ...
                                    <span class="navi-text font-size-lg"><?php echo e($contact->username); ?></span>
                                </a>
                            </div>
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            <button type="send-email" id="sendEmail" class="btn btn-success mr-2"><?php echo app('translator')->get('admin.send'); ?></button>
                            <button type="reset" id="resetForm"  class="btn btn-secondary"><?php echo app('translator')->get('admin.cancel'); ?></button>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form class="form" id="ajaxform">
                        <div class="card-body">
                            ...
                            <div class="row">
                                 <div class="col-lg-12">
                                    <h5 class="font-weight-bold mb-6"><?php echo app('translator')->get('admin.message'); ?></h5>
                                </div>
                                <div class="col-lg-12">
                                      <textarea type="text" id="message" name="message" class="form-control summernote" id="text_en" placeholder="<?php echo app('translator')->get('dashboard.enter-english-text'); ?>" >
...
<script src="<?php echo e(asset_public('admin/assets/js/pages/crud/forms/editors/summernote.js')); ?>"></script>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/MY-PORTFOLIO/resources/views/admin/contact/replay.blade.php ENDPATH**/ ?>