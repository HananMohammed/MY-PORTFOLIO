...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5"><?php echo app('translator')->get('admin.email'); ?></h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('admin.emails.index')); ?>" class="text-muted"><?php echo app('translator')->get('admin.email'); ?></a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Subheader-->
    <?php echo $__env->make('admin.settings.email.form_store', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.settings.email.form_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--begin::Entry-->
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label"><?php echo app('translator')->get('admin.email'); ?></h3>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-checkable " id="kt_datatable">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th><?php echo app('translator')->get('admin.receiveContact'); ?></th>
                                    ...
                                    <?php if(count($emails)>0): ?>
                                        ...
                                        <?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <?php endif; ?>
                                                <td><?php echo e($email->user()->pluck('name')[0]); ?></td>
                                                <td nowrap="nowrap"><?php echo e($email->id); ?></td>
                                            </tr>
        ...
        $("#newsModalEdit").on('show.bs.modal',function(event){
            ...
            $.ajax({
                ...
                success :function(data){
                    let url = "<?php echo e(url(app()->getLocale().'/admin/emails/'.':id')); ?>";
        ...
        <label class="checkbox checkbox-single">
            ...
            <a href="${currentLocation}/emails/${data}"class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
                ...
                <form id="delete-operator-form-${data}" action="${currentLocation}/${data}" method="POST" style="display: none;">
                    ...
                    {
                        targets: 2,
                        title:'<?php echo e(__('admin.receiveContact')); ?>' ,
                        width: '75px',
                        render: function(data, type, full, meta) {
                            var status = {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MY-PORTFOLIO\resources\views/admin/settings/email/index.blade.php ENDPATH**/ ?>