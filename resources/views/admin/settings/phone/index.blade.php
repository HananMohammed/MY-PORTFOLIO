...
@section('content')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('admin.phone')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.phones.index')}}" class="text-muted">@lang('admin.phone')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Subheader-->
    @include('admin.settings.phone.form_store')
    @include('admin.settings.phone.form_edit')
    <!--begin::Entry-->
            ...
            <div class="card card-custom gutter-b" style="width: 100%;">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">@lang('admin.phone')</h3>
                    </div>
                                    ...
                                    @if(count($phones)>0)
                                        ...
                                        @foreach($phones as $phone)
                                            <tr>
                                                <td>{{$phone->id}}</td>
                                                <td>{{$phone->phone}}</td>
                                                <td>{{$phone->user()->pluck('name')[0]}}</td>
                                                <td nowrap="nowrap">{{ $phone->id }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    @endif
...
@section('scripts')
    ...
    <script src="{{ asset_public('admin/assets/js/utils.js')}}"></script>
    <script>
        ...
        $("#newsModalEdit").on('show.bs.modal',function(event){
            ...
            $.ajax({
                ...
                success :function(data){
                    let url = "{{url(app()->getLocale().'/admin/phones/'.':id')}}";
