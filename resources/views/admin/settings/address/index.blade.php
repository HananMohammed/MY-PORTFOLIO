...
@section('content')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('admin.address')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.addresses.index')}}" class="text-muted">@lang('admin.address')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Subheader-->
    @include('admin.settings.address.form_store')
    @include('admin.settings.address.form_edit')
    <!--begin::Entry-->
                                    ...
                                    @if(count($addresses)>0)
                                        ...
                                        @foreach($addresses as $address)
                                            <tr>
                                                ...
                                                <td>{{ $address->user()->pluck('name')[0] }}</td>
                                                <td nowrap="nowrap">{{ $address->id }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    @endif
        ...
        $("#newsModalEdit").on('show.bs.modal',function(event){
            ...
            $.ajax({
                ...
                success :function(data){
                    let url = "{{url(app()->getLocale().'/admin/addresses/'.':id')}}";
