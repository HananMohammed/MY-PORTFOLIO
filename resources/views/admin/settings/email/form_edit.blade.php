                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="form-group">
                            <label for="emailEdit">@lang('admin.email')<label class="text-danger">*</label></label>
                            <input id="emailEdit" name="email" type="email"  class="form-control"  value="{{old('email')}}" placeholder="Enter Email Address">
                        </div>
                    </div>
                    <div class="form-group">
