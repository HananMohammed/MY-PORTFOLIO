<?php
return [
    'we-coders' => 'لوحه التحكم الخاصه بالموقع التعريفي',
    'send-at' => 'وقت الارسال',
    ...
    "setting-edit" => "اعدادات الويبسايت",
    ...
    "website-map" => "الخريطه الخاصه بالويبسايت",
    "enter-map" => "برجاء اخال كود الخريطه الخاصه بالويبسايت",
    "website-logo" => "  اللوجو الخاص بالويبسايت",
    ...
    "inbox-details" => "البريد الوارد",
    "replay" => "البريد الصادر",
    "send" => "ارسال",
    "cancel" => "الغاء",
    "new-email" => "انشاء ايميل",
    "setup" => "اعداد الايميل",
    "send-to" => "ايميل المرسل اليه : ",
